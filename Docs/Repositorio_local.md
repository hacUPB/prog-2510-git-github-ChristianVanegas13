...
5. Para ver el proyecto procedemos a ír a carpetas y luego procedemos a ír a donde dice este equipo y luego entras al disco local, buscamos el nombre del proyecto y entramos. Al entrar siempre git lo pone en una carpeta oculta, para poder verlo vas a vista y procedes
   poniendo la opción elementos ocultos, git aquí siempre pones en la carpeta oculta todos los proyectos creados. Ya sabiendo esto procedemos en git bash.
